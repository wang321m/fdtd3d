...
int main (int argc, char** argv)
{
  ...
  Scheme3D scheme (overallSize, bufferLeft, bufferRight, rank, numProcs, totalTimeSteps, false, 2 * totalTimeSteps, true, GridCoordinate3D (10, 10, 10), false, GridCoordinate3D (13, 13, 13), PhysicsConst::Pi / 2, 0, 0, false);
#endif
#else
#ifdef GRID_2D
  GridCoordinate2D overallSize (gridSizeX, gridSizeY);

  SchemeTMz scheme (overallSize, totalTimeSteps, false, 2 * totalTimeSteps, true, GridCoordinate2D (20, 0), true, GridCoordinate2D (30, 0), /*PhysicsConst::Pi / 4*/0, false);
  //SchemeTEz scheme (overallSize, totalTimeSteps, false, 2 * totalTimeSteps, true, GridCoordinate2D (20, 0), true, GridCoordinate2D (30, 0), /*PhysicsConst::Pi / 4*/0);
#endif
#ifdef GRID_3D
  GridCoordinate3D overallSize (gridSizeX, gridSizeY, gridSizeZ);

  Scheme3D scheme (overallSize, totalTimeSteps, false, 2 * totalTimeSteps, false, GridCoordinate3D (10, 10, 10), true, GridCoordinate3D (5, 5, 5), PhysicsConst::Pi / 2, 0, 0, false);
#endif
#endif
